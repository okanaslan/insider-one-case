...
const (
	...
	DefaultBulkMaxEventsPerRequest = 500
	MinBulkMaxEventsPerRequest     = 1
	MaxBulkMaxEventsPerRequest     = 5000
	DefaultBulkPerRequestTimeoutMS = 1500
	MinBulkPerRequestTimeoutMS     = 100
	MaxBulkPerRequestTimeoutMS     = 10000
)
...
type Config struct {
	...
	BulkMaxEventsPerRequest int    `env:"BULK_MAX_EVENTS_PER_REQUEST" envDefault:"500"`
	BulkPerRequestTimeoutMS int    `env:"BULK_PER_REQUEST_TIMEOUT_MS" envDefault:"1500"`
}
...
func (c Config) Normalized() Config {
	...
	c.BulkMaxEventsPerRequest = clampIntOrDefault(c.BulkMaxEventsPerRequest, DefaultBulkMaxEventsPerRequest, MinBulkMaxEventsPerRequest, MaxBulkMaxEventsPerRequest)
	c.BulkPerRequestTimeoutMS = clampIntOrDefault(c.BulkPerRequestTimeoutMS, DefaultBulkPerRequestTimeoutMS, MinBulkPerRequestTimeoutMS, MaxBulkPerRequestTimeoutMS)
	return c
}
